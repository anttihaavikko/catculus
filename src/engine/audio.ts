...
export class AudioManager {
    ...
    public land(): void {
        this.play([0.5,,136,.04,.09,.07,1,3.6,,-32,,,,.5,,,,.88,.06]);
    }
    ...
    public skill(): void {
        this.play([,,627,.01,.14,.27,1,2.9,-1,,37,.06,.08,.3,,,,.87,.13,.26]);
    }

    public preview(): void {
        this.play([.6,,313,.09,.21,.08,1,.3,,105,-168,.06,.07,,,.1,,.8,.21,.07,-1426]);
    }
    
    public pick(): void {
        // this.play([1.5,,54,,.03,.01,3,.8,,-42,,,,,,,,.71,.02,,-951]);
        // this.play([.6,,170,.01,.03,.04,2,4.5,,,,,,,,,,.95,.03,,-1443]);
        this.play([1,,105,.01,.02,.04,1,1.1,54,,43,.5,,.1,70,,,.8,.01,.01,352]);
